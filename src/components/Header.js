          ...
          <ul className="list-none flex justify-center items-center text-xl text-[#3d4152]">
            ...
            >
              <NavLink
                ...
                className={`${
                  isActive("/search") ? "text-[#f75500]" : "text-inherit"
                }`}
                to="/search"
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    ...
                    className={`w-[17px] h-[17px] ${
                      isActive("/search") ? "fill-[#f75500]" : "fill-[#686b78]"
                    }`}
                  >
                ...
                <span className="flex items-center justify-center truncate">
                  <svg
                    ...
                    className={`w-[18px] h-[19px] ${
                      isActive("/help") ? "fill-[#f75500]" : "fill-[#686b78]"
                    }`}
                  >
            ...
            >
              <NavLink
                ...
                className={`${
                  isActive("/profile") ? "text-[#f75500]" : "text-inherit"
                }`}
                to="/profile"
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    viewBox="6 0 12 24"
                    className={`w-[18px] h-[19px] ${
                      isActive("/profile") ? "fill-[#f75500]" : "fill-[#686b78]"
                    }`}
                  >
